...
class CLITests(unittest.TestCase):
    ...
    def test_parse_args_supports_digital_product_output_dir(self):
        args = parse_args(
            [
                "--portfolio-once",
                "--digital-product-output-dir",
                "out/digital-products",
            ]
        )
    ...
    def test_parse_args_supports_niche_report_output_dir(self):
        args = parse_args(
            [
                "--portfolio-once",
        ...
        self.assertEqual(args.niche_report_output_dir, "out/niche-reports")
    ...
    def test_parse_args_supports_activation_manifest_output_dir(self):
        args = parse_args(
            [
                "--portfolio-once",
                "--portfolio-phase",
    ...
    def test_parse_args_supports_offer_ladder_output_dir(self):
        args = parse_args(
            [
                "--portfolio-once",
                "--portfolio-phase",
    ...
    def test_parse_args_supports_traffic_plan_output_dir(self):
        args = parse_args(
            [
                "--portfolio-once",
                "--portfolio-phase",
        ...
        self.assertEqual(args.traffic_plan_output_dir, "out/traffic-plan")

    def test_parse_args_supports_all_ideas_output_dir(self):
        args = parse_args(
            [
                "--portfolio-once",
                "--portfolio-phase",
        ...
        self.assertEqual(args.all_ideas_output_dir, "out/all-ideas")
    ...
    def test_bundle_output_paths_use_standard_revenue_bundle_dirs(self):
        ...
        self.assertEqual(paths["niche_report_output_dir"], "out/revenue-bundle/niche-reports")
        ...
        self.assertEqual(paths["traffic_plan_output_dir"], "out/revenue-bundle/traffic-plan")
        self.assertEqual(paths["all_ideas_output_dir"], "out/revenue-bundle/all-ideas")
